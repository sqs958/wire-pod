...
func isLinkLocal(ip net.IP) bool {
	return ip.IsLoopback() || ip.Equal(net.IPv4zero) || bytes.HasPrefix(ip, []byte{169, 254}) || bytes.HasPrefix(ip, []byte{100, 64}) || bytes.HasPrefix(ip, []byte{100, 96}) || bytes.HasPrefix(ip, []byte{100, 127})
}
