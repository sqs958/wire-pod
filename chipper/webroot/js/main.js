...
function checkKG() {
    if (document.getElementById("kgProvider").value=="") {
        ...
        document.getElementById("deepseekInput").style.display = "none";
        document.getElementById("deepseekRobotNameInput").style.display = "none";
        ...
        document.getElementById("deepseekInput").style.display = "none";
        document.getElementById("deepseekRobotNameInput").style.display = "none";
    } else if (document.getElementById("kgProvider").value=="deepseek") {
        document.getElementById("openAIRobotNameInput").style.display = "none";
        document.getElementById("togetherInput").style.display = "none";
        document.getElementById("openAIInput").style.display = "none";
        document.getElementById("houndifyInput").style.display = "none";
        document.getElementById("deepseekInput").style.display = "block";

        if (document.getElementById("intentyesds") && document.getElementById("intentyesds").checked == true) {
            document.getElementById("deepseekRobotNameInput").style.display = "block";
        } else {
            document.getElementById("deepseekRobotNameInput").style.display = "none";
        }
    }
...
function sendKGAPIKey() {
    ...
    if (provider == "openai") {
        ...
        key = document.getElementById("deepseekKey").value
        model = document.getElementById("deepseekModel").value
        if (document.getElementById("intentyesds").checked == true) {
            intentgraph = "true"
            robotName = document.getElementById("deepseekRobotName").value
        } else {
            intentgraph = "false"
        }
    } else {
...
function updateKGAPI() {
    fetch("/api/get_kg_api")
        ...
        .then((response) => {
            ...
            } else if (obj.kgProvider == "deepseek") {
                document.getElementById("deepseekKey").value = obj.kgApiKey;
                document.getElementById("deepseekModel").value = obj.kgModel;
                if (obj.kgIntentGraph == "true") {
                    document.getElementById("intentyesds").checked = true;
                    document.getElementById("deepseekRobotName").value = obj.kgRobotName;
                } else {
                    document.getElementById("intentnods").checked = true;
                }
            }
            checkKG();
        })
